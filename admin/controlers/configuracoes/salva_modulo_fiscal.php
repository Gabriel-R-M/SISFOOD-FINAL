...
$grava = $db->select("UPDATE fiscal  SET csosn_sistema='$csosn_sistema', caminho_acbr='$caminho_acbr', ncm_sistema='$ncm_sistema', cst_sistema='$cst_sistema', cfop_sistema='$cfop_sistema', cnpj_desenvolvedor='$cnpj_desenvolvedor', versao_cfe='$versao_cfe', chave_sat='$chave_sat' ");	
