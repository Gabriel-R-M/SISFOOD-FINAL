...
$grava = $db->select("UPDATE configuracoes SET primeira_impressao='$primeira_impressao', impressora_principal='$impressora_principal', impressora_secundaria='$impressora_secundaria', imprimir_endereco_entrega_cozinha='$imprimir_endereco_entrega_cozinha'");
