...
<div class="col-md-4">	
		...
		<ul class="list-group">
            <li class="list-group-item upper">
            	<a tabindex="-1" href="javascript:void(0)" onclick="javascript:submenu_impressoras();"><p class="mg-b-0 thin">            		
            ...
            ?>
	            <li tabindex="-1" class="list-group-item upper" style="border-top: 0">
	            	<a href="javascript:void(0)" onclick="javascript:submenu_abre_loja_online();"><p class="mg-b-0 thin">   
	            ...
	            <li tabindex="-1" class="list-group-item upper" style="border-top: 0">
	            	<a href="javascript:void(0)" onclick="javascript:submenu_horarios_funcionamento();"><p class="mg-b-0 thin">   
                ...
                <li tabindex="-1" class="list-group-item upper" style="border-top: 0">
                    <a href="javascript:void(0)" onclick="javascript:submenu_tempo_retirada_entrega();"><p class="mg-b-0 thin">   
